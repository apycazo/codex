package apycazo.codex.rest.features.datamap;

import apycazo.codex.rest.common.Outcome;
...
public class DataMapEndpoint {
  ...
  @Autowired
  public DataMapEndpoint(DataMapService service, @Context ContainerRequestContext request,
